...
CRC32Update proc uses edi Crc32, Buf, BufLen
	mov     eax, Crc32
	not     eax
	mov     edi, Buf
	mov     ecx, BufLen
...
DupeAdd proc crc32
	...
	m2m	dword ptr[edx+4], crc32	
	
	mov	lpDupeArray, edx
	ret
DupeAdd endp

IsDuplicateFile proc uses edi mem, len
	LOCAL	crc32: DWORD
	LOCAL	found: DWORD
	...
	.IF	!found	
		invoke	DupeAdd, crc32
	.ENDIF
	
	mov	eax, found 	
	ret
IsDuplicateFile endp
...
ImpersonateLocalSystemUser proc uses ebx
	LOCAL	hToken: DWORD
